...
std::string yar::print_callstack(size_t skipLevels, bool makeFunctionNamesStandOut)
{
    std::stringstream ss;

    return print_callstack(skipLevels, makeFunctionNamesStandOut, ss);
}
std::string yar::print_callstack(size_t skipLevels, bool makeFunctionNamesStandOut, std::stringstream& ss)
{
    collect_callstack(skipLevels, makeFunctionNamesStandOut, [&ss](const std::string& str) {ss << str; });
    return ss.str();
}
void yar::collect_callstack(size_t skipLevels, bool makeFunctionNamesStandOut, const std::function<void(const std::string&)>& write)
{
...
yar::IExceptionWithCallStackBase::~IExceptionWithCallStackBase()
{
    
}

yar::ThrowOnDestroy::ThrowOnDestroy(const char* function, const char* file, int line)
{
    log_stream_ << "[" << file << ":"
        << line << "]";
}
std::ostringstream &yar::ThrowOnDestroy::stream()
{
    return log_stream_;
}

yar::ThrowOnDestroy::~ThrowOnDestroy() YAR_THROW_SPECIFIER
{
    std::stringstream ss;
    LOG(debug) << "Exception at" << yar::print_callstack(0, true, ss) << log_stream_.str();
    throw yar::ExceptionWithCallStack<std::string>(log_stream_.str(), ss.str());
}

yar::ThrowOnDestroy_trace::ThrowOnDestroy_trace(const char* function, const char* file, int line) : ThrowOnDestroy(function, file, line) {}

yar::ThrowOnDestroy_trace::~ThrowOnDestroy_trace() YAR_THROW_SPECIFIER
{
    std::stringstream ss;
...
yar::ThrowOnDestroy_info::ThrowOnDestroy_info(const char* function, const char* file, int line) : ThrowOnDestroy(function, file, line)
{
}

yar::ThrowOnDestroy_info::~ThrowOnDestroy_info() YAR_THROW_SPECIFIER
{
    std::stringstream ss;
...
yar::ThrowOnDestroy_warning::~ThrowOnDestroy_warning() YAR_THROW_SPECIFIER
{
    std::stringstream ss;
